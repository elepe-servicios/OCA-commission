...
def migrate(cr, version):
    ...
    was named 'commission' to Odoo v19 where it's renamed to 'commission_oca'.
    ...
    rename_needed = False
    if util.module_installed(cr, "commission"):
        rename_needed = True
    else:
        _logger.info(
    ...
    if util.module_installed(cr, "commission_oca") or rename_needed:    
        util.rename_fields(
            cr,"res.partner","agent_ids","commission_agent_ids",update_references=True)
